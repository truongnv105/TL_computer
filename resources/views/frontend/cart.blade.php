...
<div id="wrap-inner">
    <div id="list-cart">
        ...
        @if(Cart::getTotalQuantity() > 0)
            <form>
                <table class="table table-bordered table-responsive text-center test">
                    <tr class="active">
                    ...
                    <tr>
                        ...
                        <td class="product-price"><span id="test">{{number_format($item->price,0,",",".")}}</span></td>
                        <td class="total-price"><span>{{number_format($item->price*$item->quantity,0,",", ".")}}</span></td>
                ...
                <div class="row" id="total-price">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        <a href="{{asset('cart/update')}}" class="my-btn btn">Câp nhật</a>
